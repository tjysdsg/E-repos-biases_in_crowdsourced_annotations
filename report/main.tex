...
\begin{document}
    ...
    Table~\ref{tab:bigram2unigram_pmi} lists top associated unigrams with bigram identity labels.
    This result corresponds to our previous finding that hypothesis text contains more biases and stereotypes.
    For exapmle, \texttt{old men} and \texttt{grumpy}, \texttt{black people} and \texttt{rioting}, and
